/**
 * Evals Type System
 * Shared types for the Codex eval framework.
 */
...
export interface BridgeEvalRequest {
  isc_row: number;
  suite: string;
...
export type AlgorithmEvalRequest = BridgeEvalRequest;
export type AlgorithmEvalResult = BridgeEvalResult;
